...
class Robot:
    ...
    def right(self):
        ...
        self._head_bounder += [self._body._top_bounder[-1],
                               self._body._bottom_bounder[-1]]
        self.x_position += 1
    ...
    def left(self):
        ...
        self._head_bounder += [self._body._top_bounder[0],
                               self._body._bottom_bounder[0]]
        self.x_position -= 1
    ...
    def make_move(self, command):
        ...
        command = KEY_RIGHT, KEY_LEFT, KEY_DOWN, KEY_UP, KEY_F1,
        что соответствует повороту направо, налево, вниз, вверх и вращению
        """
        ...
        if any(point in self.hurdles_points for point in
               new_body.get_body_coord()):
