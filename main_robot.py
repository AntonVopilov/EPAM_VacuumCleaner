...
def main_graphics(stdscr, map_width, map_length, hurdles_count):
    ...
    robot_width = 3
    robot_length = 4
    robot_object = rob.Robot(map_width // 2, map_length // 2, robot_width,
                             robot_length)
    ...
    map_object = mc.MapConstructor(map_width, map_length, hurdles_max_size,
                                   hurdles_count, area)
    ...
    while True:
        ...
        stdscr.addstr(0, 0,
                      f'robot location {x_pos} {y_pos}, '
                      f'robot collision status {robot_object.collision} ',
                      curses.color_pair(1))
        map_pad.refresh(y, x, view_box[0], view_box[1], view_box[2],
                        view_box[3])
